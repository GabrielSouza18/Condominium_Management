    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="card shadow-lg o-hidden border-0 mt-2" id="cardResident">
                ...
                <div class="p-3">
                    ...
                    <div class="d-flex justify-content-center">
                        <textarea class="form-control" id="historico_mensagens" rows="10" readonly>
                            <?php
                            $sqlMensagens = "SELECT m.*, u.usu_nome AS usu_id FROM mensagem m INNER JOIN usuario u ON m.men_usu_id = u.usu_id WHERE m.men_cha_id = '$chamado_id' ORDER BY m.men_data";
                            ...
                            while ($mensagem = mysqli_fetch_assoc($resultadoMensagens)) {
                                echo $mensagem['usu_id'] . '-' . $mensagem['men_mensagem'] . "\n";
                            }
                            ?>
                        </textarea>
                    </div>
                ...
                <a class="d-flex justify-content-center" id="aRecovery" href="dashboard_resident.php">Voltar</a>
            </div>
        </div>
    </div>
    <script>
        function enviarMensagem() {
            ...
            var status = "em_andamento"; // Define o status padrão como
